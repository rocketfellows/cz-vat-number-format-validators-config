...
This package provides a preconfigured configuration class for vat number format validators for Czech Republic country.
...
- https://github.com/rocketfellows/cz-vat-format-validator v1.0.0;
...
- **_rocketfellows\CZVatNumberFormatValidatorsConfig\CZVatNumberFormatValidatorsConfig_** - preconfigured configuration class for vat number format validators for Czech Republic country;
...
Class interface:
- **_getCountry_** - returns Czech Republic **_Country_** instance;
- **_getValidators_** - returns validators tuple

When initializing the default configuration, the **_getValidators_** function returns a tuple with a single validator - an instance of CZVatFormatValidator.
