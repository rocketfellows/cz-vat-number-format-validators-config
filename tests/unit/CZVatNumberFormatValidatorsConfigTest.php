...
namespace rocketfellows\CZVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\CZVatNumberFormatValidatorsConfig\CZVatNumberFormatValidatorsConfig;

class CZVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = CZVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = CZVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::CZ(), $config->getCountry());
    }
